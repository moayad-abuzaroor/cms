...
function MoviesTable({sharedData, setSharedData}) {
  ...
  const handleEmptyShared = () => {
    setSharedData({id:null, movie_title: null, movie_description: null, movie_year: null, movie_release_date: null, movie_rate: null, movie_awards: null, movie_runtime: null,
